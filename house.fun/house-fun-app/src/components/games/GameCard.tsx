...
export const GameCard: React.FC<Readonly<GameCardProps>> = ({
    ...
    return (
        <div className="glass-panel group relative flex h-[380px] flex-col overflow-hidden rounded-xl transition-all duration-300 hover:-translate-y-1">
            {status && (
            ...
            <div className="flex flex-grow flex-col justify-between bg-gradient-to-b from-transparent to-black/20 p-5">
                <div>
                    <h3 className="mb-1 text-xl font-bold text-white uppercase tracking-tighter">{title}</h3>
