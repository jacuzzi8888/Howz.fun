        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-4">
              ...
              <button className="flex items-center gap-2 bg-primary hover:bg-primaryHover text-[#0A0A0F] px-5 py-2.5 rounded-lg font-bold text-sm transition-all shadow-[0_0_15px_rgba(7,204,0,0.3)] hover:shadow-[0_0_25px_rgba(7,204,0,0.5)]">
